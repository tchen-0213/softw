...
- 规则函数由 `UNIT-TC01` 至 `UNIT-TC09` 覆盖，实现位于 `backend/tests/businessRules.test.js`、`security.test.js`、`orderSellerQuery.test.js`、`creditRules.test.js` 和前端 `cartSlice.test.js`。

...
![图 22-DESIGN-CLASS 系统实现类图](images/png/22-DESIGN-CLASS.png)
...
![图 29-OBJ-SEQ07 UC07 评价与回复对象级顺序图](images/png/29-OBJ-SEQ07.png)

> 可编辑 Mermaid 源文件：[29-OBJ-SEQ07.mmd](models/29-OBJ-SEQ07.mmd)

### 7.8 OBJ-SEQ08 聊天议价对象调用

![图 30-OBJ-SEQ08 UC08 聊天议价对象级顺序图](images/png/30-OBJ-SEQ08.png)
...
- 页面入口由 `E2E-TC01` 至 `E2E-TC12` 覆盖，测试实现位于 `frontend/e2e/customer-flow.spec.js`。
